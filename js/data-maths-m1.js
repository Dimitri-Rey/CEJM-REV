...
registerQuiz('maths-m1', 'knowledge', [
    {
        ...
        context: "",
        hint: "Multiplie chaque bit par sa puissance de 2 (de droite a gauche : 1, 2, 4, 8)."
    },
    {
        ...
        context: "",
        hint: "255 = 256 - 1. Que vaut 2⁸ - 1 en binaire ? Pense a un octet rempli."
    },
    {
        ...
        context: "",
        hint: "F = 15 en hexa. Calcule 15×16 + 15."
    },
    {
        ...
        context: "",
        hint: "Divise 192 par 16. Le quotient donne le premier chiffre hexa (A=10, B=11, C=12...)."
    },
    {
        ...
        context: "",
        hint: "Le modulo, c'est le reste de la division euclidienne. Combien fait 10 ÷ 3 et quel est le reste ?"
    },
    {
        ...
        context: "",
        hint: "Seuls les 2 bits de poids fort sont a 1. Additionne les puissances correspondantes : 2⁷ + 2⁶."
    },
    {
        ...
        context: "",
        hint: "Chaque octet se convertit independamment. 00 reste 00, et 50 en decimal = quoi en hexa ?"
    },
    {
        ...
        context: "",
        hint: "Le mot 'octet' vient du latin 'octo'. Pense au nombre de bits dans un byte."
    },
    {
        ...
        context: "",
        hint: "En base 8, les poids sont 1, 8, 64... Calcule 1×8 + 7×1."
    },
    {
        ...
        context: "",
        hint: "Formule : a = b × q + r avec 0 ≤ r < b. Quel multiple de 5 est juste en dessous de 47 ?"
    },
    {
        ...
        context: "",
        hint: "Soustraction successive : 172 - 128 = 44. Continue avec 64, 32, 16, 8, 4, 2, 1."
    },
    {
        ...
        context: "",
        hint: "Decoupe en 2 groupes de 4 bits : 1011 | 0111. Convertis chaque nibble en chiffre hexa."
    },
    {
        ...
        context: "",
        hint: "Une IPv4 a 4 parties (ex: 192.168.1.1). Chaque partie = 1 octet. Combien de bits au total ?"
    },
    {
        ...
        context: "",
        hint: "Avec n bits, on peut representer 2ⁿ valeurs distinctes. Calcule 2⁸."
    },
    {
        ...
        hint: "Convertis les deux valeurs en decimal, additionne, puis reconvertis en hexa."
    },
    {
        ...
        context: "",
        hint: "Methode des divisions successives par 2 : note les restes et lis-les a l'envers."
    },
    {
        ...
        context: "",
        hint: "r=4, w=2, x=1. La valeur 7 est la somme maximale de ces trois permissions."
    },
    {
        ...
        context: "",
        hint: "En hexa, A = 10. Calcule 1×16 + A×1."
    },
    {
        ...
        context: "",
        hint: "Decoupe en nibbles : 1111 | 1111. Quelle lettre hexa represente 1111 (= 15) ?"
    },
    {
        ...
        context: "",
        hint: "Double depuis 2¹ : 2, 4, 8, 16, 32, 64, 128... continue encore une fois."
    },
    // ========== ARITHMÉTIQUE : Divisibilité, Nombres premiers, PGCD/PPCM, Congruences ==========
    {
        ...
        context: "",
        hint: "Critere de divisibilite par 3 : additionne les chiffres. Si la somme est divisible par 3..."
    },
    {
        ...
        context: "",
        hint: "Divise 360 par 2 autant que possible, puis par 3, puis par 5. Attention : 10 n'est pas premier !"
    },
    {
        ...
        context: "",
        hint: "Decompose les deux nombres en facteurs premiers, puis prends le minimum des exposants communs."
    },
    {
        ...
        context: "",
        hint: "PPCM = maximum des exposants dans la decomposition en facteurs premiers de chaque nombre."
    },
    {
        ...
        context: "",
        hint: "Le reste doit etre strictement inferieur au diviseur (< 17). Elimine deja les options impossibles."
    },
    {
        ...
        context: "",
        hint: "Ce n'est pas lie au fait d'etre un nombre premier. C'est une propriete du PGCD."
    },
    {
        ...
        context: "",
        hint: "23 est un nombre premier. Est-ce qu'il divise 120 ? Si non, le PGCD est tres simple."
    },
    {
        ...
        context: "",
        hint: "Fais la division euclidienne de 17 par 3. Le reste, c'est la reponse."
    },
    {
        ...
        context: "",
        hint: "Les congruences sont compatibles avec les operations de base. L'addition se conserve."
    },
    {
        ...
        context: "",
        hint: "Astuce calculatrice : prends la partie decimale du resultat et multiplie-la par le diviseur (23)."
    },
    {
        ...
        context: "",
        hint: "Divise par 2 tant que c'est pair, puis par 3, puis par 7. Verifie en multipliant le resultat."
    },
    {
        ...
        context: "",
        hint: "Teste les diviseurs premiers jusqu'a √n. L'un de ces nombres est un carre parfait."
    },
    {
        ...
        context: "",
        hint: "C'est une formule fondamentale qui relie PGCD et PPCM. Pense au produit des deux nombres."
    },
    {
        ...
        context: "",
        hint: "Cherche le plus grand multiple de 7 inferieur ou egal a 23, puis calcule la difference."
    },
    {
        ...
        context: "",
        hint: "16 = 2⁴, donc chaque chiffre hexa correspond a exactement 4 bits. Regroupe depuis la droite."
    }
]);
