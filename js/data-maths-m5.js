...
registerQuiz('maths-m5', 'knowledge', [
    {
        ...
        context: "",
        hint: "Arithmetique = ajouter. Geometrique = multiplier. Retiens cette distinction de base."
    },
    {
        ...
        context: "",
        hint: "Geometrique = on multiplie a chaque etape. Pense a un doublement de trafic reseau."
    },
    {
        ...
        context: "",
        hint: "Suite arithmetique = addition repetee. On part de u(0) et on ajoute r un certain nombre de fois."
    },
    {
        ...
        context: "",
        hint: "Suite geometrique = multiplication repetee. On multiplie u(0) par q... combien de fois ?"
    },
    {
        ...
        context: "",
        hint: "Applique u(n) = u(0) + n × r directement avec n=5."
    },
    {
        ...
        context: "",
        hint: "u(0)=100, q=2. Calcule d'abord 2 puissance 10 (valeur bien connue en IT), puis multiplie."
    },
    {
        ...
        context: "",
        hint: "Amortissement lineaire = suite arithmetique. Soustrais 800 par annee pendant 4 ans."
    },
    {
        ...
        context: "",
        hint: "Pense a Gauss : nombre de termes fois la moyenne du premier et du dernier terme."
    },
    {
        ...
        context: "",
        hint: "Croissance de 20% = multiplier par 1,20 a chaque etape. Calcule 1,2 au cube."
    },
    {
        ...
        context: "",
        hint: "La raison r = u(n+1) - u(n). Calcule la difference entre deux termes consecutifs."
    },
    {
        ...
        context: "",
        hint: "Convergente = les termes se stabilisent vers une valeur precise quand n grandit."
    },
    {
        ...
        context: "",
        hint: "Baisse de 15% = multiplier par 0,85. Applique la formule geometrique avec q=0,85 et n=2."
    },
    {
        ...
        context: "",
        hint: "Quand |q| < 1, que devient q puissance n quand n tend vers l'infini ?"
    },
    {
        ...
        context: "",
        hint: "Doublement = suite geometrique q=2. Calcule 2 puissance 4."
    },
    {
        ...
        context: "",
        hint: "Utilise u(n) = u(0) + n×r et isole u(0). Remonte la formule a l'envers."
    },
    {
        ...
        context: "",
        hint: "Applique S = u(0) × (1 - q^n) / (1 - q). Ou plus simple : additionne 1+2+4+8+16."
    },
    {
        ...
        context: "",
        hint: "Calcule d'abord combien de doublements en 6 ans (72 mois / 18 mois), puis applique 2^n."
    },
    {
        ...
        context: "",
        hint: "Calcule les premiers termes : u(0), u(1), u(2)... La suite se stabilise-t-elle ?"
    },
    {
        ...
        context: "",
        hint: "r = (u(n) - u(p)) / (n - p). Fais la difference des termes divisee par la difference des rangs."
    },
    {
        ...
        context: "",
        hint: "Pose l'inequation u(0) × q^n < 250 et resous avec le logarithme. Prends l'entier superieur."
    },
    {
        ...
        context: "",
        hint: "Formule de Gauss : S = n(n+1)/2. Applique avec n=100."
    },
    {
        ...
        context: "",
        hint: "Divise u(5) par u(2) pour obtenir q^(5-2). Puis extrais la racine cubique."
    },
    {
        ...
        context: "",
        hint: "Amortissement = (valeur initiale - valeur residuelle) / nombre d'annees."
    },
    {
        ...
        context: "",
        hint: "Compare |q| a 1 : si |q|>1, les puissances grandissent ; si |q|<1, elles diminuent."
    },
    {
        ...
        context: "",
        hint: "Fibonacci : chaque terme = somme des deux precedents. Additionne les deux derniers."
    }
]);
