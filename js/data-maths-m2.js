...
registerQuiz('maths-m2', 'knowledge', [
    {
        ...
        context: "",
        hint: "AND exige que TOUTES les entrees soient a 1 pour donner 1."
    },
    {
        ...
        context: "",
        hint: "OR donne 1 des qu'au moins une entree est a 1."
    },
    {
        ...
        context: "",
        hint: "NOT est un inverseur : il retourne le bit oppose."
    },
    {
        ...
        context: "",
        hint: "XOR = 1 quand les entrees sont differentes, 0 quand elles sont identiques."
    },
    {
        ...
        context: "",
        hint: "Pour que AND donne 1, il faut que les deux entrees soient a 1."
    },
    {
        ...
        context: "",
        hint: "De Morgan : on casse la barre, on inverse l'operateur (AND devient OR)."
    },
    {
        ...
        context: "",
        hint: "De Morgan : NOT sur un OR donne un AND avec les termes complementes."
    },
    {
        ...
        context: "",
        hint: "Pense a la loi d'absorption : une variable 'absorbe' l'expression qui la contient."
    },
    {
        ...
        context: "",
        hint: "Une variable peut-elle etre vraie ET fausse en meme temps ?"
    },
    {
        ...
        context: "",
        hint: "L'une des deux (A ou son complement) est forcement vraie."
    },
    {
        ...
        context: "",
        hint: "Quelle operation conserve les bits ou le masque vaut 1 et met a 0 le reste ?"
    },
    {
        ...
        context: "",
        hint: "Le broadcast met tous les bits d'hote a 1. Quel operateur force des bits a 1 ?"
    },
    {
        ...
        context: "",
        hint: "NAND = NOT(AND). Calcule d'abord le AND, puis inverse le resultat."
    },
    {
        ...
        context: "",
        hint: "En Boole, les seules valeurs possibles sont 0 et 1 — pas d'addition classique."
    },
    {
        ...
        context: "",
        hint: "Loi d'absorption : x + x.y = x, le terme x.y est redondant."
    },
    {
        ...
        context: "",
        hint: "Fais le XOR bit par bit : meme valeur = 0, valeurs differentes = 1."
    },
    {
        ...
        context: "",
        hint: "Wildcard Cisco : 0 = verifier ce bit, 255 = ignorer. C'est l'inverse du masque."
    },
    {
    ...
    },
    {
        ...
        context: "",
        hint: "Propriete d'idempotence : appliquer deux fois la meme chose ne change rien."
    },
    {
        ...
        context: "",
        hint: "AND avec 0 : comme un interrupteur ouvert, rien ne passe."
    },
    {
        ...
        context: "",
        hint: "Element neutre : ajouter 0 ne change pas la valeur. Teste avec a=0 et a=1."
    },
    {
        ...
        context: "",
        hint: "OR avec 1 : si une entree est deja a 1, la sortie est forcement..."
    },
    {
        ...
        context: "",
        hint: "Inverser deux fois revient a ne pas inverser — comme un double clic sur un toggle."
    },
    {
        ...
        context: "",
        hint: "En Boole, le OR se distribue sur le AND : a + b.c = (a+b).(a+c). Verifie avec une table."
    },
    {
        ...
        context: "",
        hint: "NOR = NOT(OR). Calcule le OR d'abord, puis inverse."
    },
    {
        ...
        context: "",
        hint: "NOR = NOT(OR). Si le OR vaut 1, que donne NOT(1) ?"
    },
    {
        ...
        context: "",
        hint: "Que vaut a.a_barre ? Une variable ET son complement donnent toujours..."
    },
    {
        ...
        context: "",
        hint: "Karnaugh = outil visuel pour regrouper et eliminer des variables."
    },
    {
        ...
        context: "",
        hint: "Nombre de cases = 2 puissance n, ou n est le nombre de variables."
    },
    {
        ...
        context: "",
        hint: "Formule : 2^n cases. Calcule 2 puissance 4."
    },
    {
        ...
        context: "",
        hint: "Ce codage garantit qu'entre deux cases voisines, un seul bit change."
    },
    {
        ...
        context: "",
        hint: "Theoreme d'absorption : x + x.y = x. Identifie x et y dans l'expression."
    },
    {
        ...
        context: "",
        hint: "Un minterm utilise TOUTES les variables liees par un AND. Produit ou somme ?"
    }
]);
